...
// Case funds are ANONYMIZED (described by era/category, not named) pending the
// WRDS licence-scope answer; the returns and gaps are unchanged.
...
export const behaviorGap: BehaviorGap = {
  ...
  "cases": [
    {
      "name": "A dot-com era innovation fund",
      "tw": 0.0699,
      "dw": -0.2047,
      "gapPP": 0.2746,
      "years": "1994–2005"
    ...
    {
      "name": "A concentrated growth fund",
      "tw": 0.0343,
      "dw": -0.175,
      "gapPP": 0.2093,
      "years": "1995–2009"
