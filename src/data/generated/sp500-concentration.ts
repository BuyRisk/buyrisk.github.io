...
// a few decade snapshots. (The treemap panel was trimmed to exactly that on
// 2026-08-27, pending the WRDS licence-scope answer.) Weights/shares are fractions (0.34 = 34%); effN is the
...
export interface Sp500Concentration {
  ...
  /** Decade-snapshot month → top-10 holdings + an "other" tile, for the treemap
   *  scrubber. Trimmed from the former annual top-30 panel pending the WRDS
   *  licence-scope answer: decade top-10 is the level our published dataset
   *  note describes, and the level defensible as effectively public knowledge. */
...
export interface TreemapSnapshot {
  /** Priced index members that month. */
  n: number;
  /** Combined weight of every stock outside the top 10 (one "other" tile). */
  other: number;
