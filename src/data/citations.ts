...
export const DATASETS: Record<string, Dataset> = {
  ...
  pastorStambaugh: {
    ...
    note: "The traded liquidity factor (LIQ_V) of Pástor & Stambaugh (2003), monthly from January 1968, from Ľuboš Pástor's Chicago Booth data page. No usage terms are published; we ship its long-run annualized premium only.",
  },
  petajisto: {
  ...
  crsp: {
    ...
    note: "Source: CRSP®, Center for Research in Security Prices, Booth School of Business, The University of Chicago. Used with permission. All rights reserved. Accessed through WRDS under an academic subscription; only aggregate, non-identifiable statistics are published here — never a per-security series.",
  },
  crspSp500: {
    name: "CRSP S&P 500 Indexes & Daily Constituents",
    publisher: "Center for Research in Security Prices, LLC, via WRDS",
    url: "https://www.crsp.org/",
    note: "Source: CRSP®, Center for Research in Security Prices, The University of Chicago. Used with permission. All rights reserved. We ship only index-level aggregates — month-end concentration, index returns, and decade snapshots of the top-10 tickers by weight; no per-stock time series is redistributed. Pending written confirmation of the licence's scope for public educational use.",
  },
  crspMf: {
  ...
  thomsonS12: {
    ...
    note: "Used under license. Fund portfolio overlap is computed from quarterly holdings filings; only anonymized fund-level summaries are published (Fund A–L, ordered by assets) — no names, no positions. Pending written confirmation of the licence's scope for public educational use.",
  },
  shiller: {
    name: "U.S. Stock Markets 1871–Present and CAPE Ratio",
    publisher: "Robert J. Shiller, Yale University",
    url: "https://shillerdata.com/",
    note: "The spreadsheet (ie_data.xls) behind Irrational Exuberance, republished by its author with a disclaimer and no usage terms. We ship monthly real total returns and the CAPE series derived from it, with attribution.",
  },
  damodaran: {
    name: "Historical Returns on Stocks, Bonds, Bills & Real Estate — United States",
  ...
  ftseGlobalAllCap: {
    ...
    note: "Monthly factsheet for the whole-world index Vanguard's VT tracks (© LSEG; reproduction of the factsheet requires permission). Only its headline region weights and constituent count are cited here, with attribution; the site records the as-at month it used.",
  },
  vanguardVT: {
  ...
  ssa: {
    ...
    note: "Period life table, wage index, bend points and COLA history. US government work in the public domain.",
  },
  ici: {
    ...
    note: "Li, Lei (2026), 'Trends in the Expenses and Fees of Funds, 2025,' ICI Research Perspective 32(1), © Investment Company Institute. ICI permits brief, attributed excerpts; the asset-weighted average expense ratios quoted here are such excerpts, linked to the report, and no underlying data are republished.",
  },
  spiva: {
    ...
    note: "© S&P Dow Jones Indices LLC. S&P DJI prohibits redistribution or reproduction of the report without permission; only a few specific figures are transcribed here, with attribution, as brief factual quotation.",
  },
};
