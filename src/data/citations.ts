...
export const DATASETS: Record<string, Dataset> = {
  ...
  crspSp500: {
    ...
    publisher: "Center for Research in Security Prices, LLC, via WRDS",
    url: "https://www.crsp.org/",
    note: "Used under license. We ship only index-level aggregates — month-end concentration, index returns, and decade snapshots of the top-10 tickers by weight; no per-stock time series is redistributed. Pending written confirmation of the licence's scope for public educational use.",
  },
  crspMf: {
    name: "CRSP Survivor-Bias-Free US Mutual Fund Database",
    publisher: "Center for Research in Security Prices, LLC, via WRDS",
    url: "https://www.crsp.org/",
    note: "Used under license. The behavior gap is computed from fund monthly returns and net assets; only universe-level aggregates and a few anonymized illustrative cases (described by era and category, not named) are published — no per-fund panel is redistributed. Pending written confirmation of the licence's scope for public educational use.",
  },
  irsRevProc: {
