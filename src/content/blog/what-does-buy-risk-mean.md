---
title: "What Does It Actually Mean to 'Buy Risk'?"
description: "Every investment return is compensation for bearing some risk. Understanding that trade is the foundation of everything else."
pubDate: 2026-06-02
...
Imagine two ways to store $10,000 for a year.
...
because the market is generous, but because most people dislike uncertainty.
To get them to hold the uncertain asset, it has to offer a *higher expected
reward*. That extra expected reward is called the **risk premium**.

> Risk and expected return are two sides of the same coin. You cannot reliably
...
Across our articles and [interactive tools](/tools), we'll build up the
intuition to answer questions like:

1. How much does time actually reduce the risk of holding stocks?
