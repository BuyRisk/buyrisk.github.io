...
description: "Spreading your bets can lower risk without lowering expected return. Here's the intuition behind why that's not too good to be true."
pubDate: 2026-07-09
...
## Risks that don't move together
...
- Owning 1 stock: fully exposed to that company's fate.
- Owning 20 well-chosen stocks: most single-company risk is already gone.
- Owning a broad index fund: you hold thousands of companies at once, capturing
  the market's systematic premium while shedding nearly all the noise.

This is why "buy the whole market" is such durable advice. You're not being
clever; you're refusing to hold a risk you won't be paid for.

## Coming soon

We're building an interactive **portfolio diversification simulator** for the
[Tools](/tools) section, so you can watch a portfolio's volatility fall as you
add uncorrelated holdings. Until then, read
[The Quiet Magic of Compounding](/blog/the-magic-of-compounding/) to see what
those steadier returns do over decades.
