...
/**
 * Animated S&P 500 concentration treemap. Each tile is a stock (the top 10 by
  ...
  return (
    <div className="ic-tm">
      ...
      <p className="wl-fnote">
        ...
        share of the whole index; the gray tile is every stock outside the top 10. Hit <em>play</em> to watch the giants
