...
The name is the thesis, with one qualification the site is careful about:
expected return is compensation for bearing risk that cannot be diversified
away. Company-specific risk can be shed for free by holding many companies, so
markets pay no premium for it. The site teaches the durable, well-supported findings of finance
